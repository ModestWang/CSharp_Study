...
namespace Machine_Learning
{
    ...
    {
        public const string RetrainFilePath =  @"D:\Code\VS_code\C#\Study\Machine_Learning\Machine_Learning\Datasets\sentiment labelled sentences\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.03125F,L2Regularization=1.713414F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}))      
